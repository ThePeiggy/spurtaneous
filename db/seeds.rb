...
#   Mayor.create(name: 'Emanuel', city: cities.first)
	...
	user.causes.new(name: "Single Parents’ Free Daycare", description: "SPFD is a non-profit organization started by Martha 
							...
							image: "http://1.bp.blogspot.com/-cYIpih0xqV0/UbeGQQy8_gI/AAAAAAAAAo8/Hkm2uBICaXM/s1600/single-dad-cartoon.jpg").save
	...
	user.causes.new(name: "You Are Luidaso’s Hero", description: "In 2046, Luidaso suffered a terrible earthquake, followed 
							...
							image: "http://images.thevine.com.au/resources/images/000/003/3179_melbourne%20quake%202012_200612100132_591w.png").save
	...
	user.causes.new(name: "Feminism in the Middle East Countries", description: "Although feminism in Western countries has 
							...
							image: "http://inshia.com/wp-content/uploads/2014/11/muslim-women-demographic-jihad.jpg").save
	...
	user.causes.new(name: "Children in Technology", description: "Children’s childhood has changed severely since the 1990’s. 
							...
							image: "http://twstheunagency.files.wordpress.com/2011/01/child_with_computer.jpg").save

	user.causes.new(name: "Children in Technology", description: "In the year 6billion (today, March, 6,000,600,004 a.E.A 
							...
							image: "http://astronoteen.org/wp-content/uploads/2014/08/800px-People_looking_at_stars.jpg").save